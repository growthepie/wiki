...
<summary>Participating in Gitcoin Grants</summary>
...
To see the most recent average transaction cost on PGN check [here](https://www.growthepie.xyz/fundamentals/transaction-costs).
...
<summary>PGN is ready to go</summary>
...
By leveraging Blockchain technology, PGN introduces greater transparency and efficiency into the funding process, ensuring resources reach the projects where they are needed most.
...
<summary>Now conducting Gitcoin Grants</summary>

[GG18](https://www.gitcoin.co/blog/gitcoin-grants-round-18-results-and-recap), was conducted on the PGN network. In which we were also a proud participant.
...
<summary><strong>Daily Active Addresses</strong></summary>

To see the trend of the usage and user base of PGN check [here](https://www.growthepie.xyz/fundamentals/daily-active-addresses).
